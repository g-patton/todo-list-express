const deleteBtn = document.querySelectorAll('.fa-trash') //  creating a 
// variable and assignin gto it a selection of all elements witht a 
// class of the trash can 
const item = document.querySelectorAll('.item span') // creating a 
// variable and assinging it to a selection of span tags inside of 
// a parent that has a class of item
const itemCompleted = document.querySelectorAll('.item span.completed')
// creating variable and assgning it to a selection of spans with a class
// of completed inside of a parent with a class of item
